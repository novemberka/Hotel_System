...
{
    partial class History_Customer
    {
        /// <summary> 
        ...
        private void InitializeComponent()
        {
            ...
            Booking_Status.CustomizableEdges = customizableEdges7;
            ...
            Booking_Status.ShadowDecoration.CustomizableEdges = customizableEdges8;
            ...
            SelectDateRoport.Location = new Point(19, 12);
            ...
            Customer_history.Location = new Point(13, 212);
            Customer_history.Name = "Customer_history";
            Customer_history.Size = new Size(1411, 472);
            Customer_history.TabIndex = 13;
            Customer_history.TabStop = false;
            Customer_history.Text = "Customer History";
            // 
            // label25
            // 
            ...
            dataGridView1.Columns.AddRange(new DataGridViewColumn[] { CustomerName, PhoneNumber, Room, Status, Note });
