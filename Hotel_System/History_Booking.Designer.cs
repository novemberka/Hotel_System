namespace Hotel_System
{
    partial class History_Booking
    {
        ...
        private void InitializeComponent()
        {
            ...
            Customer_history.Location = new Point(17, 203);
            Customer_history.Name = "Customer_history";
            Customer_history.Size = new Size(1455, 800);
            Customer_history.TabIndex = 15;
            Customer_history.TabStop = false;
            Customer_history.Text = "Booking History";
            // 
            // label25
            // 
